...
# UI - tabs ---------------------------------------------------------------
        ...
        tabItems(
            tabItem(tabName = "about",
                    ...
                    p("The OH-EpiCap tool was published in Frontiers in Public Health by Henok Ayalew Tegegne, Carlijn Bogaardt, Lucie Collineau, Géraldine Cazeau, Renaud Lailler, Johana Reinhardt, Frederick T. A. Freeth, Emma Taylor, Joaquin M. Prada, and Viviane Hénaux. (2023). OH-EpiCap: A semi-quantitative tool for the evaluation of one health epidemiological surveillance capacities and capabilities.", em("Frontiers in Public Health,"), "11, 1053986.", tags$a("https://doi.org/10.3389/fpubh.2023.1053986", href="https://doi.org/10.3389/fpubh.2023.1053986"), "please see the Publications tab to view other published works using the OH-EpiCap tool."),
            ...
            tabItem(tabName = "publications",
                    ...
                    tags$ol(style = "text-align:left!important",
                      tags$li("Henok Ayalew Tegegne, Carlijn Bogaardt, Lucie Collineau, Géraldine Cazeau, Renaud Lailler, Johana Reinhardt, Frederick T. A. Freeth, Emma Taylor, Joaquin M. Prada, and Viviane Hénaux. (2023). OH-EpiCap: A semi-quantitative tool for the evaluation of one health epidemiological surveillance capacities and capabilities.", em("Frontiers in Public Health,"),"11, 1053986.", tags$a("https://doi.org/10.3389/fpubh.2023.1053986", href="https://doi.org/10.3389/fpubh.2023.1053986")),
                      tags$li("Moura, P., Collineau, L., Sandberg, M., Tomassone, L., De Meneghi, D., Norström, M., ... & Alban, L. (2023). Users’ perception of the OH-EpiCap evaluation tool based on its application to nine national antimicrobial resistance surveillance systems.", em("Frontiers in Public Health,"),"11, 1138645.", tags$a("https://doi.org/10.3389/fpubh.2023.1138645", href="https://doi.org/10.3389/fpubh.2023.1138645")),
